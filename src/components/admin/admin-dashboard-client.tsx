...
import {
  Users, Car, Calendar, DollarSign, ShieldAlert, CreditCard,
  Star, TrendingUp, LogOut, LayoutDashboard, FileCheck, Settings
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { icon: Car, label: 'Instrutores', href: '/admin/instrutores' },
  { icon: DollarSign, label: 'Pagamentos', href: '/admin/pagamentos' },
  { icon: FileCheck, label: 'Fila KYC', href: '/admin/kyc' },
